...
#include "communication_msgs/msg/detail/answer__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const communication_msgs::msg::Answer & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  communication_msgs::msg::Answer & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = communication_msgs::msg::Answer;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const communication_msgs::msg::Answer *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<communication_msgs::msg::Answer *>(
    untyped_ros_message);
...
{
  return &communication_msgs::msg::typesupport_fastrtps_cpp::_Answer__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, communication_msgs, msg, Answer)() {
  return &communication_msgs::msg::typesupport_fastrtps_cpp::_Answer__handle;
}
