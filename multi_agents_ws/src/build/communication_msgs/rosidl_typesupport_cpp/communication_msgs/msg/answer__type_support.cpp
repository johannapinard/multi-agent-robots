...
static const _Answer_type_support_symbol_names_t _Answer_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, communication_msgs, msg, Answer)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, communication_msgs, msg, Answer)),
  }
};
...
get_message_type_support_handle<communication_msgs::msg::Answer>()
{
  return &::communication_msgs::msg::rosidl_typesupport_cpp::Answer_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, communication_msgs, msg, Answer)() {
  return get_message_type_support_handle<communication_msgs::msg::Answer>();
}
