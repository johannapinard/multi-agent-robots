...
communication_msgs__msg__Introduction__init(communication_msgs__msg__Introduction * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->name)) {
    communication_msgs__msg__Introduction__fini(msg);
    return false;
  }
  // available_actions
...
communication_msgs__msg__Introduction__create(void)
{
  ...
  communication_msgs__msg__Introduction * msg = (communication_msgs__msg__Introduction *)allocator.allocate(sizeof(communication_msgs__msg__Introduction), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(communication_msgs__msg__Introduction));
  bool success = communication_msgs__msg__Introduction__init(msg);
  if (!success) {
...
communication_msgs__msg__Introduction__Sequence__init(communication_msgs__msg__Introduction__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  communication_msgs__msg__Introduction * data = NULL;

  if (size) {
    if (size > SIZE_MAX / sizeof(communication_msgs__msg__Introduction)) {
      return false;
    }
    data = (communication_msgs__msg__Introduction *)allocator.zero_allocate(size, sizeof(communication_msgs__msg__Introduction), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = communication_msgs__msg__Introduction__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        communication_msgs__msg__Introduction__fini(&data[i - 1]);
      }
...
communication_msgs__msg__Introduction__Sequence__fini(communication_msgs__msg__Introduction__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      communication_msgs__msg__Introduction__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  communication_msgs__msg__Introduction__Sequence * array = (communication_msgs__msg__Introduction__Sequence *)allocator.allocate(sizeof(communication_msgs__msg__Introduction__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = communication_msgs__msg__Introduction__Sequence__init(array, size);
  if (!success) {
...
communication_msgs__msg__Introduction__Sequence__destroy(communication_msgs__msg__Introduction__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    communication_msgs__msg__Introduction__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
communication_msgs__msg__Introduction__Sequence__are_equal(const communication_msgs__msg__Introduction__Sequence * lhs, const communication_msgs__msg__Introduction__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!communication_msgs__msg__Introduction__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  communication_msgs__msg__Introduction__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(communication_msgs__msg__Introduction)) {
      return false;
    }
    const size_t allocation_size =
      input->size * sizeof(communication_msgs__msg__Introduction);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    communication_msgs__msg__Introduction * data =
      (communication_msgs__msg__Introduction *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!communication_msgs__msg__Introduction__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          communication_msgs__msg__Introduction__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!communication_msgs__msg__Introduction__copy(
