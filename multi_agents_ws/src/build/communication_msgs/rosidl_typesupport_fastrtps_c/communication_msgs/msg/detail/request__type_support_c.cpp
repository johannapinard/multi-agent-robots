...
#include "communication_msgs/msg/detail/request__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // action_name, to
#include "rosidl_runtime_c/string_functions.h"  // action_name, to
...
using _Request__ros_msg_type = communication_msgs__msg__Request;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_communication_msgs
bool cdr_serialize_communication_msgs__msg__Request(
  const communication_msgs__msg__Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_communication_msgs
bool cdr_deserialize_communication_msgs__msg__Request(
  eprosima::fastcdr::Cdr & cdr,
  communication_msgs__msg__Request * ros_message)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_communication_msgs
size_t get_serialized_size_communication_msgs__msg__Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_communication_msgs
size_t max_serialized_size_communication_msgs__msg__Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = communication_msgs__msg__Request;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_communication_msgs
bool cdr_serialize_key_communication_msgs__msg__Request(
  const communication_msgs__msg__Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_communication_msgs
size_t get_serialized_size_key_communication_msgs__msg__Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Request__ros_msg_type * ros_message = static_cast<const _Request__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_communication_msgs
size_t max_serialized_size_key_communication_msgs__msg__Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const communication_msgs__msg__Request * ros_message = static_cast<const communication_msgs__msg__Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_communication_msgs__msg__Request(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  communication_msgs__msg__Request * ros_message = static_cast<communication_msgs__msg__Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_communication_msgs__msg__Request(cdr, ros_message);
}

static uint32_t _Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_communication_msgs__msg__Request(
...
static size_t _Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_communication_msgs__msg__Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, communication_msgs, msg, Request)() {
