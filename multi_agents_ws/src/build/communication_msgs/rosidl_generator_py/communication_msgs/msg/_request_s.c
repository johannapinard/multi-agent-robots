...
bool communication_msgs__msg__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("communication_msgs.msg._request.Request", full_classname_dest, 39) == 0);
  }
  communication_msgs__msg__Request * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("communication_msgs.msg._request");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Request");
